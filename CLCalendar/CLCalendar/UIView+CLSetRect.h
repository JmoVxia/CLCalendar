 ...
 */
#define  CLstatusBarAndNavigationBarHeight   (CLstatusBarHeight + 44.f)

/**
 *  iPhone4 or iPhone4s
 */
#define  iPhone4_4s     (CLscreenWidth == 320.f && CLscreenHeight == 480.f ? YES : NO)

/**
 *  iPhone5 or iPhone5s
 */
#define  iPhone5_5s     (CLscreenWidth == 320.f && CLscreenHeight == 568.f ? YES : NO)

/**
 *  iPhone6 or iPhone6s
 */
#define  iPhone6_6s     (CLscreenWidth == 375.f && CLscreenHeight == 667.f ? YES : NO)

/**
 *  iPhone6Plus or iPhone6sPlus
 */
#define  iPhone6_6sPlus (CLscreenWidth == 414.f && CLscreenHeight == 736.f ? YES : NO)

/**
 *  iPhoneX
 */
#define  iPhoneX (CLscreenWidth == 375.f && CLscreenHeight == 812.f ? YES : NO)
